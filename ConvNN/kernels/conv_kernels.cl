...
__kernel void pooling( global float* prevfeatMap,global float* poolMap,global int* indexes,int Width,int pooldim){
...
__kernel void deltas(global Node * nodes,global Node * nextnodes,global float *deltas,global int *indexes,int dim,int nextnumNodes,int pooldim){
...
__kernel void rotatemat( global float* source,global float* destin,int dim){
...
__kernel void backpropcnn( global float* featMap,global float* deltas,global Filter* filters,int featmapdim,int imagedim,int filterdim,float a,global float* Image){
...
__kernel void cnntoFcnn(global float* poolMap,global Node* nodes,int inputsize,int mapindex){
